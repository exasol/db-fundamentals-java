# Exasol Database fundamentals for Java 0.1.4, released 2025-10-30

Code name: Ugrade Project Keeper
...
* Updated `com.exasol:error-code-crawler-maven-plugin:1.1.2` to `2.0.5`
* Updated `com.exasol:project-keeper-maven-plugin:2.6.2` to `5.4.3`
...
* Updated `org.codehaus.mojo:versions-maven-plugin:2.10.0` to `2.19.1`
